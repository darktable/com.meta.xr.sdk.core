...
Shader "Meta/Lit Transparent"
{
    Properties
    {
        ...
        _Surface("__surface", Float) = 1.0 // opaque | transparent
    ...
    SubShader
    {
        ...
        #pragma surface surf Standard fullforwardshadows addshadow alpha:blend
    ...
    CustomEditor "Oculus.ShaderGUI.MetaLitTransparent"
}
