...
namespace Meta.XR
{
    ...
    [MetaOpenXRFeature(
        featureId: featureId,
        uiName: "Detached Meta Quest Touch Pro Controller Profile",
        desc: "Allows for mapping input to the Meta Quest Touch Pro Detached Controller interaction profile.",
        version: "0.0.1",
        category: FeatureCategory.Interaction,
        extensions: new[] { "XR_META_detached_controllers" })]
#endif
    public class DetachedMetaQuestTouchProControllerProfile : OpenXRInteractionFeature
    {
        public const string featureId = "com.meta.openxr.feature.input.metaquestpro.detached";

        [Preserve, InputControlLayout(displayName = "Detached Meta Quest Pro Touch Controller(OpenXR)", commonUsages = new[] { "LeftHand", "RightHand" })]
        public class DetachedQuestProTouchController : XRControllerWithRumble
        {
        ...
        private const string kDeviceLocalizedName = "Detached Meta Quest Pro Touch Controller OpenXR";

        protected override void RegisterDeviceLayout()
        {
            InputSystem.RegisterLayout(typeof(DetachedQuestProTouchController),
        ...
        {
            InputSystem.RemoveLayout(nameof(DetachedQuestProTouchController));
        }

        protected override string GetDeviceLayoutName()
        {
            return nameof(DetachedQuestProTouchController);
        }
        ...
        protected override void RegisterActionMapsWithRuntime()
        {
            ...
            {
                name = "detachedquestprotouchcontroller",
