...
namespace Meta.XR
{
    ...
    [MetaOpenXRFeature(
        featureId: featureId,
        uiName: "Detached Meta Quest Touch Plus Controller Profile",
        desc: "Allows for mapping input to the Meta Quest Touch Plus Detached Controller interaction profile.",
        version: "0.0.1",
        category: FeatureCategory.Interaction,
        extensions: new[] { "XR_META_detached_controllers" })]
#endif
    public class DetachedMetaQuestTouchPlusControllerProfile : OpenXRInteractionFeature
    {
        public const string featureId = "com.meta.openxr.feature.input.metaquestplus.detached";

        [Preserve, InputControlLayout(displayName = "Detached Meta Quest Touch Plus Controller(OpenXR)", commonUsages = new[] { "LeftHand", "RightHand" })]
        public class DetachedQuestTouchPlusController : XRControllerWithRumble
        {
        ...
        private const string kDeviceLocalizedName = "Detached Meta Quest Touch Plus Controller OpenXR";

        protected override void RegisterDeviceLayout()
        {
            InputSystem.RegisterLayout(typeof(DetachedQuestTouchPlusController),
        ...
        {
            InputSystem.RemoveLayout(nameof(DetachedQuestTouchPlusController));
        }

        protected override string GetDeviceLayoutName()
        {
            return nameof(DetachedQuestTouchPlusController);
        }
        ...
        protected override void RegisterActionMapsWithRuntime()
        {
            ...
            {
                name = "detachedquesttouchpluscontroller",
