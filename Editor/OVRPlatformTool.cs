    ...
    public class OVRPlatformTool : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            OVRPlatformToolSettings.TargetPlatform =
                (TargetPlatform)MakeEnumPopup(TargetPlatformLabel, OVRPlatformToolSettings.TargetPlatform);
            ...
            commandMenuScroll = EditorGUILayout.BeginScrollView(commandMenuScroll, GUILayout.Height(Screen.height / 2));
            {
                ...
                OVRPlatformToolSettings.ReleaseChannel =
                    MakeTextBox(ReleaseChannelLabel, OVRPlatformToolSettings.ReleaseChannel);

                // Releaes Note
                GUIContent ReleaseNoteLabel = new GUIContent("Release Note: ");
                OVRPlatformToolSettings.ReleaseNote =
                    MakeTextBox(ReleaseNoteLabel, OVRPlatformToolSettings.ReleaseNote);
                ...
                if (OVRPlatformToolSettings.TargetPlatform == TargetPlatform.Rift)
                {
                    ...
                    OVRPlatformToolSettings.RiftBuildDirectory = MakeFileDirectoryField(BuildDirLabel,
                    ...
                    OVRPlatformToolSettings.RiftBuildVersion =
                        MakeTextBox(BuildVersionLabel, OVRPlatformToolSettings.RiftBuildVersion);

                    GUIContent LaunchFileLabel = new GUIContent("Launch File Path [?]: ",
                        "The full path to the executable that launches your app.");
                    OVRPlatformToolSettings.RiftLaunchFile = MakeFileDirectoryField(LaunchFileLabel,
                ...
                else
                {
                    ...
                    OVRPlatformToolSettings.ApkBuildPath = MakeFileDirectoryField(ApkPathLabel,
                ...
                OVRPlatformToolSettings.UploadDebugSymbols = MakeToggleBox(uploadDebugSymbolsLabel,
...
#pragma warning restore CS0618 // Type or member is obsolete
                        ...
                        OVRPlatformToolSettings.DebugSymbolsDirectory = MakeFileDirectoryField(DebugSymbolLabel,
                        ...
                        OVRPlatformToolSettings.UploadDebugSymbolsOnly = MakeToggleBox(uploadSymbolsOnlyLabel,
                        ...
                        if (OVRPlatformToolSettings.UploadDebugSymbolsOnly)
                        {
                            ...
                            OVRPlatformToolSettings.BuildID =
                                MakeTextBox(BuildIDLabel, OVRPlatformToolSettings.BuildID);
                        }
                    }
                ...
                showOptionalCommands =
                    EditorGUILayout.Foldout(showOptionalCommands, "Optional Commands", boldFoldoutStyle);
                if (showOptionalCommands)
                {
                    ...
                    if (OVRPlatformToolSettings.TargetPlatform == TargetPlatform.Rift)
                    {
                        ...
                        OVRPlatformToolSettings.RiftLaunchParams = MakeTextBox(LaunchParamLabel,
                        ...
                        OVRPlatformToolSettings.RiftFirewallException = MakeToggleBox(FirewallExceptionLabel,
                        ...
                        OVRPlatformToolSettings.RiftGamepadEmulation = (GamepadType)MakeEnumPopup(GamepadEmulationLabel,
                        ...
                        if (show2DCommands)
                        {
                            ...
                            OVRPlatformToolSettings.Rift2DLaunchFile = MakeFileDirectoryField(LaunchFile2DLabel,
                            ...
                            OVRPlatformToolSettings.Rift2DLaunchParams = MakeTextBox(LaunchParam2DLabel,
                                OVRPlatformToolSettings.Rift2DLaunchParams);

                            DecrementIndent();
                        }

                        showRedistCommands = EditorGUILayout.Foldout(showRedistCommands, "Redistributable Packages",
                            boldFoldoutStyle);
                        if (showRedistCommands)
                        {
                            ...
                            {
                                GUIContent RedistPackageLabel =
                                    new GUIContent(OVRPlatformToolSettings.RiftRedistPackages[i].name);
                                OVRPlatformToolSettings.RiftRedistPackages[i].include =
                                    MakeToggleBox(RedistPackageLabel,
                                        OVRPlatformToolSettings.RiftRedistPackages[i].include);
                            }
                        ...
                        showExpansionFileCommands = EditorGUILayout.Foldout(showExpansionFileCommands,
                        ...
                        if (showExpansionFileCommands)
                        {
                            ...
                            OVRPlatformToolSettings.LanguagePackDirectory = MakeFileDirectoryField(LanguagePackLabel,
                    ...
                    else
                    {
                        ...
                        if (showExpansionFileCommands)
                        {
                            ...
                            OVRPlatformToolSettings.ObbFilePath = MakeFileDirectoryField(ObbPathLabel,
                    ...
                    if (showExpansionFileCommands)
                    {
                        ...
                        string assetsDirectory = MakeFileDirectoryField(AssetsDirLabel,
            ...
            if (GUI.Button(rt, btnTxt, GUI.skin.button))
            {
                if (EditorUtility.DisplayDialog("Cancel Upload Process",
                        "Are you sure you want to cancel the upload process?", "Yes", "No"))
                {
            ...
            EditorGUILayout.LabelField(
                "<b>Meta Quest Developer Hub</b> is a desktop companion tool that can upload builds, manage apps and reduce friction in daily Quest development.",
                odhCalloutStyle);
        ...
        static void Command(TargetPlatform targetPlatform, string dataPath, string uploadCommand)
        {
            ...
            ovrPlatUtilProcess.ErrorDataReceived += new DataReceivedEventHandler(
                (s, e) => { OVRPlatformTool.log += e.Data + "\n"; }
            );
        ...
        private static bool genUploadCommand(TargetPlatform targetPlatform, out string command)
        {
            ...
            if (targetPlatform == TargetPlatform.Rift)
            {
                ...
                ValidateTextField(DirectoryValidator, OVRPlatformToolSettings.RiftBuildDirectory,
                    "Rift Build Directory", ref success);
                command += " --build-dir \"" + OVRPlatformToolSettings.RiftBuildDirectory + "\"";

                // Add Rift Launch File
                ValidateTextField(FileValidator, OVRPlatformToolSettings.RiftLaunchFile, "Rift Launch File Path",
                    ref success);
                command += " --launch-file \"" + OVRPlatformToolSettings.RiftLaunchFile + "\"";

                // Add Rift Build Version
                ValidateTextField(GenericFieldValidator, OVRPlatformToolSettings.RiftBuildVersion, "Build Version",
                    ref success);
                ...
                {
                    ValidateTextField(LaunchParameterValidator, OVRPlatformToolSettings.RiftLaunchParams,
                        "Launch Parameters", ref success);
                ...
                {
                    ValidateTextField(FileValidator, OVRPlatformToolSettings.Rift2DLaunchFile, "2D Launch File",
                        ref success);
                    ...
                    {
                        ValidateTextField(LaunchParameterValidator, OVRPlatformToolSettings.Rift2DLaunchParams,
                            "2D Launch Parameters", ref success);
                ...
                {
                    ValidateTextField(DirectoryValidator, OVRPlatformToolSettings.LanguagePackDirectory,
                        "Language Pack Directory", ref success);
            ...
            else
            {
                ...
                if (OVRPlatformToolSettings.UploadDebugSymbols)
                {
                    ValidateTextField(DirectoryValidator, OVRPlatformToolSettings.DebugSymbolsDirectory,
                        "Debug Symbols Directory", ref success);
            ...
            if (!string.IsNullOrEmpty(OVRPlatformToolSettings.AssetsDirectory))
            {
                ValidateTextField(DirectoryValidator, OVRPlatformToolSettings.AssetsDirectory, "Assets Directory",
                    ref success);
                ...
                if (OVRPlatformToolSettings.AssetConfigs.Count > 0)
                {
                    ...
                    for (int i = 0; i < OVRPlatformToolSettings.AssetConfigs.Count; i++)
                    {
                        ...
                        {
                            string configString = "\\\"" + config.name + "\\\":{" +
            ...
            // Add Release Channel
            ValidateTextField(GenericFieldValidator, OVRPlatformToolSettings.ReleaseChannel, "Release Channel",
                ref success);
        ...
        static void ValidateTextField(FieldValidatorDelegate<string, string, bool> fieldValidator, string fieldText,
            string fieldName, ref bool success)
        {
            string error = "";
        ...
        private string MakeFileDirectoryField(GUIContent label, string variable, string title, bool isFile = false,
            string extension = "")
        {
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField(label, GUILayout.ExpandWidth(false));
        ...
        private static void DrawAssetConfigElement(Rect rect)
        {
            ...
            if (OVRPlatformToolSettings.AssetConfigs.Count > 0)
            {
                for (int i = 0; i < OVRPlatformToolSettings.AssetConfigs.Count; i++)
                {
                    ...
                    config.SetFoldoutState(EditorGUI.Foldout(elementRect, config.GetFoldoutState(), config.name,
                        boldFoldoutStyle));
                    if (config.GetFoldoutState())
                    {
                        Rect attributeRect = new Rect(elementRect.x + INDENT_SPACING,
                        ...
                        fieldLabel = new GUIContent("Required Asset [?]",
                        ...
                        config.type =
                            (AssetConfig.AssetType)EditorGUI.EnumPopup(attributeRect, fieldLabel, config.type);
        ...
        private static void DrawAssetConfigHeader(Rect rect)
        {
            ...
            EditorGUI.DrawRect(headerRect,
                EditorGUIUtility.isProSkin ? new Color(0.37f, 0.37f, 0.37f) : new Color(0.55f, 0.55f, 0.55f));
            EditorGUI.LabelField(rect, "Asset File Configuration");
        }

        private static void DrawAssetConfigBackground(Rect rect)
        {
            Rect backgroundRect = new Rect(rect.x, rect.y + SINGLE_LINE_SPACING, rect.width,
                GetAssetConfigElementHeight());
            EditorGUI.DrawRect(backgroundRect,
                EditorGUIUtility.isProSkin ? new Color(0.3f, 0.3f, 0.3f) : new Color(0.63f, 0.63f, 0.63f));
        }
