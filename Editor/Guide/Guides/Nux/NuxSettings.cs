...
namespace Meta.XR.Guides.Editor.Nux
{
    internal static class NuxSettings
    {
        ...
        // Footer navigation labels — fixed UI chrome, not remote-controlled.
        internal static class Footer
        {
            internal const string Back = "Back";
            internal const string Next = "Next";
            internal const string GetStarted = "Get Started";
            internal const string FinishSetup = "Finish setup";
        }
    }
}
